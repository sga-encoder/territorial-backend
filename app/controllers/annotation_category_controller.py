...
from app.services.annotation_category_service import AnnotationCategoryService
...
bp = Blueprint("annotation_category", __name__, url_prefix="/api/annotation-categories")
service = AnnotationCategoryService()
