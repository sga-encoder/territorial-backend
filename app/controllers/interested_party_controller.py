...
from app.services.interested_party_service import InterestedPartyService
...
bp = Blueprint("interested_party", __name__, url_prefix="/api/interested-parties")
service = InterestedPartyService()
